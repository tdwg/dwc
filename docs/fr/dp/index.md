...
Consider a dataset containing four bird _Occurrences_ observed during a single parent _Event_. The data can be captured in two CSV files, each representing a DwC-DP table:
